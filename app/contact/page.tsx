      ...
      <main className="min-h-screen bg-[#faf8f4] px-6 py-20">
        <div className="mx-auto grid max-w-5xl gap-10 lg:grid-cols-[1fr_1.3fr]">
          <div className="rounded-[2rem] bg-white p-8 shadow-sm">
            <h1 className="text-4xl font-black">{t.contact.title}</h1>
            ...
            <div className="mt-8 space-y-4 text-sm">
              <div>
                <p className="font-bold text-neutral-500">{t.contact.phoneLabel}</p>
                <p className="mt-1 font-black">{SITE_CONTACT.phoneDisplay}</p>
              </div>

              <div>
                <p className="font-bold text-neutral-500">{t.contact.addressLabel}</p>
